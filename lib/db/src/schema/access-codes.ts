...
export const insertAccessCodeSchema = createInsertSchema(accessCodesTable).omit({ id: true, createdAt: true, usedAt: true, usedBy: true, expiresAt: true, redeemerName: true, redeemerEmail: true, redeemerWhatsapp: true });
