      ...
      <div className="flex flex-col items-center pt-12 pb-8 max-w-3xl mx-auto text-center space-y-6">
        ...
        <div className="w-full relative mt-4 group">
          ...
          <div className="relative flex items-center w-full">
            <Search className="absolute left-6 h-5 w-5 text-white dark:text-white" />
            <Input
              type="text"
              placeholder="Buscar por artista, música, letra ou código..."
              className="w-full h-16 pl-14 pr-6 rounded-full bg-black border-white/30 text-white placeholder:text-white/60 text-lg shadow-sm focus-visible:ring-white focus-visible:border-white dark:bg-[hsl(55,100%,50%)] dark:border-white/30 dark:text-white dark:placeholder:text-white/60 dark:focus-visible:ring-white dark:focus-visible:border-white transition-all"
              value={searchTerm}
