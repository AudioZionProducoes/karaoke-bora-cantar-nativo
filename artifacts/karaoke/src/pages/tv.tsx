  ...
  return (
    <div className="min-h-screen bg-black text-white relative overflow-hidden flex flex-col">
      ...
      <div className="flex-1 flex items-center justify-center bg-black min-h-0 relative">
        ...
        <img src="/logo.jpeg" alt="Karaokê Bora Cantar" className="absolute top-4 right-4 z-10 h-20 w-20 object-contain rounded-xl opacity-50 hover:opacity-80 transition-opacity pointer-events-none shadow-lg shadow-black/40" />
